...
Write-Output 'Candidate repository migration chain 0001-0025 local-only, target, and verification safety checks passed; applied/remote status was not inspected.'
