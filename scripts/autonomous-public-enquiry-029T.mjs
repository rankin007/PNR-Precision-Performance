...
export const BRANCH = "codex/029T-readiness-boundary-recovery-after-inert-preview";
...
export const IMPLEMENTATION_FILES = Object.freeze([
  "scripts/PreflightAuth029T.ps1",
  "scripts/autonomous-public-enquiry-029T.mjs",
  "scripts/provider-browser-projection-029T.mjs",
  "scripts/test-autonomous-public-enquiry-029T.mjs",
  "scripts/test-provider-browser-projection-029T.mjs",
  "package.json",
  "docs/PUBLIC_ENQUIRY_READINESS_BOUNDARY_RECOVERY_029T.md",
]);
...
const BASELINE_KEYS = Object.freeze([
  ...
  "temporaryAuthRowCount", "genericSmtpRowCount", "credentialState", "sprintDeploymentCount",
...
export function validateBaselineProjection(value) {
  if (!exactKeys(value, BASELINE_KEYS)
    || value.controller !== "029T" || value.operation !== "baseline" || value.state !== "pass"
    || value.projectClass !== "exact" || value.dedicatedSmtpRowCount !== 0
    || value.temporaryAuthRowCount !== 0 || value.genericSmtpRowCount !== 5
...
export function validateDeploymentProjection(value) {
  if (!exactKeys(value, DEPLOYMENT_KEYS)
    || value.controller !== "029T" || value.operation !== "deploy" || value.state !== "pass"
    || !DEPLOYMENT_ID.test(value.deploymentId) || value.targetClass !== "production"
    || value.readinessClass !== "ready" || value.aliasCount !== 0
    || value.metadataClass !== "exact-029T" || value.sourceClass !== "exact-canonical") fail("DEPLOYMENT_REFUSED");
