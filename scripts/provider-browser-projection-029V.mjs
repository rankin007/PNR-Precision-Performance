export const CONTROL_PROJECTION_NAME = "provider-control-029V";
export const TARGET_KEY_NAME = "Precision Performance public enquiry 029V";
...
export function projectProviderInventory(snapshot) {
  const refused = { projection: "provider-inventory-029V", stateClass: "refused" };
  try {
    ...
    return {
      projection: "provider-inventory-029V",
      stateClass: "accepted",
...
export function projectVercelEnvironmentMetadata(snapshot) {
  const refused = { projection: "vercel-environment-029V", stateClass: "refused" };
  try {
    if (!exactKeys(snapshot, [
    ...
    return {
      projection: "vercel-environment-029V",
      stateClass: "accepted",
