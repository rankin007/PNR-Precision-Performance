...
check(serverSource.includes('rpc<Array<{') && serverSource.includes('>>("prove_trainer_enquiry_retention")') && serverSource.includes("enquiryRetained: 1 as const") && serverSource.includes("fixtureResidue: 0 as const"), "retention proof maps only exact sanitized counts");
