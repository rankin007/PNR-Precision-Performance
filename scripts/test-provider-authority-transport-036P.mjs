...
equal(capabilityRun.status, 1);
equal(capabilityRun.stdout, "");
ok(/CANONICAL_GUARD_REFUSED/.test(capabilityRun.stderr));
...
equal(protectedRedirected.status, 1);
ok(protectedRedirected.stdout === "");
ok(/CANONICAL_GUARD_REFUSED/.test(protectedRedirected.stderr));
