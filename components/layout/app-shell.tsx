...
type AppShellProps = {
  ...
  navigationPlacement?: "sidebar" | "header";
...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#eef8ef_0%,#dcefdc_100%)]">
      <div className={`section-wrap min-h-screen px-4 py-5 md:px-8 ${navigationPlacement === "sidebar" ? "grid gap-6 md:grid-cols-[260px_minmax(0,1fr)]" : "grid gap-5"}`}>
        {navigationPlacement === "sidebar" ? (
        ...
        <div className="grid gap-5">
          <header className="rounded-[2rem] border border-ink/10 bg-white/85 px-6 py-5 shadow-panel">
            <div className="flex flex-col gap-4">
              ...
              {navigationPlacement === "header" ? headerNavigation : null}
            </div>
          </header>
