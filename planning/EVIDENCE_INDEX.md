...
17. `planning/reviews/035D-email-otp-cutover-and-mailbox-checkpoint.md` — exact Preview/production/template cutover proof, bounded single-request OTP non-delivery result, and Auth-last `0/0/0` cleanup.
