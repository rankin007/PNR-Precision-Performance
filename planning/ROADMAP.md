...
**About:** About 6 named sprints on the current road
**Last estimated:** 2026-08-04
**Delivered since this roadmap was adopted:** 5 sprints - 034B, 034C, 034D, safely rolled-back 036 and preflight-blocked-clean 036B
**Next destination:** Architect decision on corrective Sprint 036C or deliberate non-promotion
...
- Sprints 034B, 034C, 034D, 036 and 036B are closed. Sprint 036B is safe but did not establish live trainer access; no corrective 036C work is applied or authorized. Sprint 029N remains gated.
- Historical sprints are not duplicated as done rows. The mid-flight statement and lifecycle ledger preserve that history.
- Production aliases remain five/five on the compatible Sprint 035D rollback after Sprint 036B stopped before any release mutation. Preview acceptance remains distinct from Production acceptance.
