...
Immediate Sprint 029 follow-up: preserve the marketing-preview deployment boundary and plan any broader public website, commerce, authenticated, SEO/indexing, or production-readiness work separately. If an operator or reviewer still sees old public content or a broken visual, first hard-refresh/private-window test the exact live URL and compare against the Sprint 029J Edge DevTools screenshot evidence.
