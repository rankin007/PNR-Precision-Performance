...
Immediate Sprint 029 follow-up: preserve the marketing-preview deployment boundary and choose a safe repository backup/review strategy, preferably a scoped release branch rather than a broad `develop` push while unrelated 021-series dirty work remains unresolved. If an operator or reviewer still sees old public content or a broken visual, first hard-refresh/private-window test the exact live URL and compare against the Sprint 029J Edge DevTools screenshot evidence and Sprint 029K post-cleanup public smoke.
